...
; Copies (CTRL + C)
MButton & RButton::Send, ^{c} ; hold the middle mouse button and right click.
return

; Pastes (CTRL + V)
MButton & LButton::Send, ^{v} ; hold the middle mouse button and left click.
return
...
MButton & XButton2::Send, {Home} ; hold the middle mouse button and click the forward mouse button.

; Presses the END key.
MButton & XButton1::Send, {End} ; hold the middle mouse button and click the back mouse button.